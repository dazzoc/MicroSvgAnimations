...
notifications.addEventListener('click', () => {
    gsap.fromTo('.bell', {rotation: -5}, {rotation: 0, duration: 2, ease: "elastic.out(4, 0.2)"});
    gsap.fromTo('.ringer', {rotation: -3, x: 0.5}, {rotation: 0, x: 0, duration: 1, ease: "elastic.out(4, 0.2)"});
    gsap.fromTo('.wave', {scale: 0, opacity: 1}, {scale: 1.3, opacity: 0, duration: 1})
});

// Messages Click Animation ===============================================================
